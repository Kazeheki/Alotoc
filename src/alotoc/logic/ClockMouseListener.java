...
/**
 * This is a MouseListener specifically for the clock/main dialog.
 * 
 * @author Kazeheki
 *
 */
public class ClockMouseListener implements MouseListener {
	 ...
	 *            The frame the listener belongs to.
	 */
	public ClockMouseListener(final AbstractAlotocFrame f) {
		frame = f;
	}
	...
	/**
	 * Check whether the preferences button was clicked. It will close the
	 * frame.
	 * 
	 * @param e
	 *            The MouseEvent that occurred.
	 * @return Whether the preferences button was clicked.
	 */
	private boolean checkPref(final MouseEvent e) {
		boolean clicked = false;

		final int x = frame.getWidth() - Constants.SMALL_SIDE_PNL_SIZE;
		final int y = Constants.SMALL_SIDE_PNL_SIZE;
		final int ex = frame.getWidth();
		final int ey = Constants.SMALL_SIDE_PNL_SIZE + y;
